...
export default function ForgetPassword() {
    ...
    async function ResetCode(values){
        try {
            ...
            toast(data.status,{className:"bg-primary h6 p-1 text-white"});
    ...
    <div className='px-0 px-md-5 my-5 pt-5'>
        ...
        <button className='btn mb-5 btn-text'>Verify Code</button>
    </div>
</form>: <div className="my-5 pt-5">
<Helmet>
...
<form onSubmit={formik1.handleSubmit} className='w-75 mx-auto'>
    <div className="w-75 mx-auto px-0 px-md-5">
        ...
        <button className="btn mb-5 btn-text mt-2">Send email</button>
    </div>
</form>
</div>}
        </>
